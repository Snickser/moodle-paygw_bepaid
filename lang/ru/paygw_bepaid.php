...
$string['bepaid'] = 'биПейд (все доступные)';
...
Новые версии плагина вы можете найти на <a href=https://github.com/Snickser/moodle-paygw_bepaid>GitHub.com</a>
...
Пожалуйста, обеспечьте наличие указанной суммы на вашем счёте {$a->nextpay}, иначе подписка не будет продлена.
Отключить регулярные платежи можно в разделе Отчёты (оплата) в личном профиле {$a->url}/user/profile.php';
$string['message_success_completed'] = 'Здравствуйте, {$a->firstname}!
Платёжная транзакция № {$a->orderid} на {$a->localizedcost} успешно завершена. Спасибо за оплату.
Если элемент курса недоступен, обратитесь в техподдержку сайта.';
$string['message_success_recurrent'] = 'Здравствуйте, {$a->firstname}!
Регулярный платёж № {$a->orderid} на {$a->localizedcost} успешно выполнен. Спасибо за оплату.
...
$string['password_text'] = 'Если у вас нет возможности произвести оплату, то попросите у вашего куратора пароль и введите его.';
...
$string['recurrent_help'] = 'Регулярные (рекуррентные) платежи исполняются по таймеру без участия студента, данные первого платежа сохраняются на стороне банка и используются повторно, с некоторой периодичностью. <b>Неправильная настройка может привести к опустошению банковских счетов клиентов!</b>';
...
$string['skipmode_text'] = 'Если вы не имеете возможности совершить оплату через платёжную систему, то можете нажать на кнопку внизу.';
...
$string['vatcode_help'] = 'Ставка НДС согласно API документации биПейд.';
